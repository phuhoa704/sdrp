      ...
      {!isStockFormOpen && (
        <div className="pb-32 animate-fade-in space-y-8 min-h-full relative">
          <Breadcrumb
            items={[
              { label: 'SỔ SÁCH', href: '#' },
              { label: 'PHIẾU NHẬP HÀNG', href: '#' }
            ]}
          />
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 px-1">
            <div className="shrink-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="bg-blue-100 dark:bg-blue-900/30 text-emerald-500 dark:text-blue-400 text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest">
                  Type Architecture
                </span>
                <Receipt size={12} className='text-blue-500 animate-pulse' />
              </div>
