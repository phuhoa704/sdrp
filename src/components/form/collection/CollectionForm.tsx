...
export const CollectionForm: React.FC<CollectionFormProps> = ({ initialData, onBack, onSave }) => {
  ...
  useEffect(() => {
    if (initialData) {
      fetchCollectionProducts(initialData.id);
      setFormData({
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6 pb-20">
      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-12 lg:col-span-4 space-y-6">
          <Card>
            <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest mb-6 pl-3 border-l-4 border-amber-500">Cấu hình thông tin</p>
